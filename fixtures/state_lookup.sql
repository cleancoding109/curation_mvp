-- Reference table: state_lookup
-- This table should be created directly in the SDL schema with reference data

CREATE TABLE IF NOT EXISTS ltc_insurance.standardized_data_layer.state_lookup (
  state_code STRING,
  state_name STRING,
  region STRING
);
...
INSERT OVERWRITE ltc_insurance.standardized_data_layer.state_lookup VALUES
  ('AL', 'Alabama', 'South'),
  ('AK', 'Alaska', 'West'),
  ('AZ', 'Arizona', 'West'),
  ('AR', 'Arkansas', 'South'),
